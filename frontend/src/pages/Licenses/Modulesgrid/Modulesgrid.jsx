...
const ModulesGrid = ({ user }) => {
  ...
  const modules = useMemo(() => {
    ...
    const allModules = [
      ...
      {
        name: 'Licenses_Staff Medicals',
        image: '/images/folder.webp',
        subheadings: [
          { title: 'Hiring/Tests', path: '/Licenses/HiringTests' },
          { title: 'Recurring Medical Tests', path: '/Licenses/RecurringMedicalTests' },
          { title: 'Vaccine Record', path: '/Licenses/VaccineRecord' },
        ],
      },
      {
        name: 'Licenses_Tourism Licenses',
        image: '/images/folder.webp',
        subheadings: [
          { title: 'Licenses', path: '/Licenses/TourismLicenses' },
        ],
      },
      {
        name: 'Licenses_Labour Licenses',
        image: '/images/folder.webp',
        //path: '/Licenses/LabourLicenses',
        subheadings: [
          { title: 'Licenses', path: '/Licenses/LabourLicenses' },
        ],
      },
    ];
